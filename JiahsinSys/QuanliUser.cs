...
{
    public partial class QuanliUser : Form
    {
        private const string FORM_CODE="UMZ01";
        private bool[] priArr={};
        ...
        public QuanliUser(string name):this()
        {
            this.G_UserID = name;
        }
        private void SetBt()
        ...
        private void QuanliUser_Load(object sender, EventArgs e)
        {
            SetBt();
